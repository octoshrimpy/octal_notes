...
from octal.__init__ import DEVELOPMENT, __version__

PYTEST = "pytest" in sys.modules

parser = argparse.ArgumentParser(description='Paint in the terminal.', usage='%(prog)s [options] [filename]', prog="octal")
